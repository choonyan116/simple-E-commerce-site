...
<body>
    ...
    <div class="container">
        <h2>Error log record</h2>
        <table class="table table-bordered">
            <tr>
                <th>Error Log ID</th>
                <th>Attempt username</th>
                <th>Attempt password</th>
                <th>Timestamp</th>
                <th>Operation</th>
            </tr>
            <?php
            ...
            ?>
                <tr>
                    ...
                    <td class="data"><?php echo $row['attempt_username']; ?></td>
                    <td class="data"><?php echo $row['attempt_password']; ?></td>
                    <td class="data"><?php echo $row['timestamp']; ?></td>
                    <td><a class="btn btn-danger" href="delete-error.php?eId=<?php echo $row['id']; ?>">Remove</a></td>
                </tr>
