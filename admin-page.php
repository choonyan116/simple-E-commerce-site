...
<body>
    ...
    <div class="container" >
        <h2>Product Add/Update/Delete</h2>
        <a class="btn btn-success pull-right" href="create.php">Add new product +</a>
        <table class="table table-bordered">
            ...
            ?>
                <tr>
                    <td class="data"><?php echo $row['pId']; ?></td>
                    <td class="data"><?php echo $row['pName']; ?></td>
                    <td class="data"><?php echo $row['pImgPath']; ?></td>
                    <td class="data"><?php echo $row['pDesc']; ?></td>
                    <td class="data"><?php echo $row['pPrice']; ?></td>
                    <td class="data"><?php echo $row['pQuant']; ?></td>
                    <td class="data"><?php echo $row['pLink']; ?></td>
                    <td class="data"><a class="btn btn-info" href="update.php?pId=<?php echo $row['pId']; ?>">Update</a>
                    <a class="btn btn-danger" href="delete.php?pId=<?php echo $row['pId']; ?>">Remove</a></td>
                </tr>
